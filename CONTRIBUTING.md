# Contributing to DevWeave

We welcome contributions to the DevWeave project! Whether you're reporting a bug, suggesting a new feature, or fixing a typo, your input is valuable to us. Here are some guidelines to help you get started:

Thank you for considering contributing to dev-weave! Follow the steps below to contribute:
...
2. **Clone the Repository:** Clone your forked repository to your local machine:
   ```bash
   git clone https://github.com/<your_username>/DevWeave.git
   ```
...
If you find a bug while using DevWeave, please report it by opening an issue on Github. Please include the following information:
...
Thank you for contributing to DevWeave! Your efforts make a difference.
