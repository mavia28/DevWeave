...
You can view the live preview of the project [here](https://dev-weave-live.vercel.app/).
...
2. **Clone the repository:**
   ```bash
   git clone https://github.com/<your-username>/DevWeave.git
   ```
3. **Create .env file:**
...
2. **Pull Docker Images:**
   ...
   ```bash
   # Pull Backend Image
   docker pull sahilatahar/dev-weave-server:latest

   # Pull Frontend Image
   docker pull sahilatahar/dev-weave-client:latest
   ```
...
3. **Run Docker Containers:**
   ...
   docker run -d -p 3000:3000 --name dev-weave-server sahilatahar/dev-weave-server:latest

   # Run Frontend Container (Port 5173)
   docker run -d -p 5173:5173 --name dev-weave-client sahilatahar/dev-weave-client:latest
   ```
...
We welcome contributions to make DevWeave even better! Follow the [contribution guidelines](CONTRIBUTING.md) to get started.
...
<a href="https://github.com/sahilatahar/DevWeave/graphs/contributors">
   <img src="https://contrib.rocks/image?repo=sahilatahar/DevWeave" />
</a>
